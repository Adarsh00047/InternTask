...
tags_metadata = [
    {
        "name": "upload",
        "description": "Post your document to this endpoint to perform classification",
    }
]


app = FastAPI(title="Document Classifier",
              summary="Document Classifier for Aadhar, Pan Cards, Passport and Voter ID using Google OCR",
              version="1.0",
            ...
            try:
                ...
                for image_file in image_files:
                    ...
                    for doc_type in document_types:
                        if doc_type == "aadhar" and len(document_types) == 1:
